...
const TokoList = ({ kategori, sort, currentPage, search, onData }) => {
    ...
    return (
        <div className="my-4">
            {/* <p className="text-sm text-samara-text/60 mb-4">
                Menampilkan <span className="font-bold text-samara-text">{toko.length}</span> dari{" "}
                <span className="font-bold text-samara-text">{total}</span> toko
